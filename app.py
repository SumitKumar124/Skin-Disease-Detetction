...
# # Find and update the BatchNormalization layer's axis parameter
# for layer in model.layers:
#     if isinstance(layer, BatchNormalization):
#         # Set the axis parameter as an integer
#         layer.axis = 3  # Or whatever appropriate value based on your model architecture
...
# Other imports and code go here
